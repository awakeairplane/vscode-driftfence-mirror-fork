...
import { PromptsServiceCustomizationItemSource } from './promptsServiceCustomizationItemSource.js';
...
export class AICustomizationListWidget extends Disposable {
	...
	private readonly promptsServiceItemSource: IAICustomizationItemSource;
	...
	constructor(
		...
		super();
		this.promptsServiceItemSource = new PromptsServiceCustomizationItemSource(
	...
	private getItemSource(descriptor: ReturnType<ICustomizationHarnessService['getActiveDescriptor']>): IAICustomizationItemSource {
		if (descriptor.itemProvider || descriptor.syncProvider) {
		...
		return this.promptsServiceItemSource;
	}
