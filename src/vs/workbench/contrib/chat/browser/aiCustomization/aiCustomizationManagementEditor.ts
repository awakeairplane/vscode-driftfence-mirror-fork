...
export class AICustomizationManagementEditor extends EditorPane {
	...
	private createWelcomePage(parent: HTMLElement): void {
		...
		subtitle.textContent = localize('welcomeSubtitle', "Define how AI agents behave in your projects. Create agents, skills, instructions, and hooks, or connect MCP servers and plugins to extend what Copilot can do.");
